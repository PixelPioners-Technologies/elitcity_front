...
export default function FavoriteComplex({
  ...
  const get_private_apartment_StatusTranslation = (
    status,
    selectedLanguage
  ) => {
    const statusTranslations = {
    ...
    <div>
      <div className="ComplexBoxInFavoritesPages">
        ...
        {favorites && favorites.length > 0 && (
          <div>
            <h1 className="item_header">
              {" "}
              {language_chage(selectedLanguage).complexes}
            </h1>
        ...
        {favoritesPhysical && favoritesPhysical.length > 0 && (
          <div>
            <h1 className="item_header">
              {" "}
              {language_chage(selectedLanguage).private_apartments}{" "}
            </h1>
            <div className="same_items">
              {/* for physical */}
              {favoritesPhysical &&
                favoritesPhysical.map((complex, index) => (
                  <div className="card" key={index}>
                    ...
                    <img
                      ...
                      style={styles.imageStyles}
                    />
                    <p className="p_apartment_title_f">
                      {complex.privateApartmentName}
                    </p>
                    <div className="textInfo_f">
                      <p className="p_apartment_addres_f">
                        {complex?.address?.city}
                      ...
                      <div className="complex_status_and_rank_container_f">
                        <p className="p_apartment_status_f">
                          {get_private_apartment_StatusTranslation(
                            complex?.status,
                            selectedLanguage
                          )}
                        </p>
        ...
        {favoritesLots && favoritesLots.length > 0 && (
          <div>
            <h1 className="item_header">
              {" "}
              {language_chage(selectedLanguage).ground}{" "}
            </h1>
            <div className="same_items">
              {/* for Lots */}
              {favoritesLots &&
                favoritesLots.map((complex, index) => (
                  <div className="card" key={index}>
                    ...
                    <div className="textInfo_f">
                      <p className="ground_address_f">
                        {complex.address.city}
                        {"  ,  "} {complex.address.address}{" "}
                      </p>
                      <p className="ground_squareprice_f">
                        {" "}
                        {language_chage(selectedLanguage).meterPriceHomePage}
                        {"  :  "} {complex.squarePrice}{" "}
                      </p>
                      <div className="complex_status_and_rank_container_f">
                        <p className="ground_status_f">
                          {get_ground_StatusTranslation(
                            complex.status,
                            selectedLanguage
                          )}
                        </p>
