...
export default function Developers({ favorites, selectedLanguage }) {
  ...
  const LanguageChangeForCompanyPage = (lang) => {
    ...
    switch (lang) {
      ...
      case "ka":
        ...
        languageInfo.developers = "დეველოპერული კომპანიები";
  ...
  const otherCompanies = developers.filter(
    (developer) => !developer.topCompany
  );
    ...
    <div className="developers_main_container">
              ...
              >
                ...
                >
                  ...
                  <div className="second_developers_child_container">
                    <img
                      className="company_background_image"
                      src={developers.backgroundImage}
                      rel="company background image"
                    />
                  </div>
                </div>
              </motion.div>
        ...
        <div className="button-modal-container">
          <div className="lacation_button">
            <input
              ...
              type="text"
              placeholder={
                LanguageChangeForCompanyPage(selectedLanguage).search_by_string
              }
      ...
      <div className="startDiv">
        {otherCompanies.map((developers, index) => (
          <div
            className="big_container_for_key"
            key={index}
            onClick={() => handle_company_click(developers.id)}
          >
            <div
