...
export default function EachComplex({ selectedLanguage, handleCallButtonClick }) {
  const sliderImages = [
    { id: 1, value: img1 },
    { id: 2, value: img2 },
    { id: 3, value: img3 },
  ...
  }, [selectedLanguage, selectedCity, min_square_price,
        ...
        {DATA.map((complex, index) => (
          <div key={index} className='complexTextsBox'>
            ...
            <div className='numberAndCallRequestBox'>
              ...
              <div className='callRequestBox' onClick={handleCallButtonClick}  >
